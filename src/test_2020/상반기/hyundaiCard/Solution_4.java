...
public class Solution_4 {
	...
	private static void bfs(int color, int x, int y) {
	...
	public static String[] solution(int[][] macaron) {
		...
		for (int i = 0; i < macaron.length; i++) {
			dropmac(macaron[i][0] - 1, macaron[i][1]);
			boom();
			dropAll();
		}
		boom();
	...
	public static void main(String[] args) {
		System.out.println(Arrays.toString(solution(new int[][] { { 1, 1 }, { 2, 1 }, { 1, 2 }, { 3, 3 }, { 6, 4 },
				{ 3, 1 }, { 3, 3 }, { 3, 3 }, { 3, 4 }, { 2, 1 } })));
	}
